...
ActiveRecord::Schema.define(version: 20160328082317) do
  ...
  add_index "contacts", ["owner_id", "user_id"], name: "index_contacts_on_owner_id_and_user_id", unique: true, using: :btree
  ...
  create_table "giphs", force: :cascade do |t|
    t.integer  "user_id"
    t.text     "url"
    t.datetime "created_at",       null: false
    t.datetime "updated_at",       null: false
